"""
Finetunes a T5 model on danish lyrics.

Inspired by: https://medium.com/@radicho/fine-tuning-the-multilingual-t5-model-from-huggingface-with-keras-f7f619ec5cfe
...
if __name__ == '__main__':
    ...
    tokenizer = MT5Tokenizer.from_pretrained('t5-base')
    model = TFMT5ForConditionalGeneration.from_pretrained('t5-base')
